...
public class GUICategory extends javax.swing.JFrame {
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        Category category = service.category.findCategoryById(categoryId);
        if (category == null) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (Messages.showConfirmDialog("Está seguro que desea eliminar esta categoria?", "Confirmación") == JOptionPane.YES_NO_OPTION) {
            if (service.category.deleteCategory(categoryId)) {
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        GUICategoryFind instance = new GUICategoryFind(this, true, service.category);
        instance.setVisible(true);
    ...
    private void addCategory() {
        ...
        if (service.category.saveCategory(name)) {
    ...
    private void editCategory() {
        ...
        if (service.category.editCategory(categoryId, category)) {
