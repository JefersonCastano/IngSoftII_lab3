...
public class GUICategoryFind extends javax.swing.JDialog {
    ...
    private void initializeTable() {
        ...
        if(listCategories.get(0)==null) return;
    ...
    private void initComponents() {
        ...
        pnlNorth.setMinimumSize(new java.awt.Dimension(1, 39));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(rdoId.isSelected()){
            try{
                categories.add(categoryService.findCategoryById(Long.valueOf(txtSearch.getText())));
            }catch(Exception e){
                Messages.showMessageDialog("Ingrese un id valido", "Atención");
            }
            
        }else if(rdoName.isSelected()){
            categories = categoryService.findCategoryByName(txtSearch.getText());
        }
