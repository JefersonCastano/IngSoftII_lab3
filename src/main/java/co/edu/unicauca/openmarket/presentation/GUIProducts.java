...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        if (prod == null) {
            ...
            cbxCategoria.setSelectedIndex(Integer.parseInt(prod.getCategory().getCategoryId().toString()));
        }
    ...
    private void addProduct() {
        ...
        Long catId = (long) cbxCategoria.getSelectedIndex();
    ...
    private void editProduct() {
        ...
        prod.setCategory(service.category.findCategoryById((long) cbxCategoria.getSelectedIndex()));
